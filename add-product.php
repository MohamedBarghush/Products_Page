<?php
  ...
  include "Includes/product.ink.php";
  include "Includes/modify_product.ink.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    ?>
    <form id="product_form" method="POST" name="form1">
        ...
        <div id="furnitureForm">
            <div class="container">
                ...
                <input type="text" name="dimension" id="height" class="op" placeholder="0x0x0">
            </div>
        </div>
        <div id="bookForm">
            <div class="container">
